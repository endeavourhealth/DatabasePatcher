package org.endeavour.databasepatcher.framework.config;

import org.endeavour.databasepatcher.framework.config.models.Config;
import org.endeavourhealth.databasepatcher.core.XmlSerializer;
...
public abstract class ConfigSerializer {
    ...
    private static Config deserializeConfig() throws Exception {
        ...
        String property = System.getProperty("databasepatcher.configurationFile");
